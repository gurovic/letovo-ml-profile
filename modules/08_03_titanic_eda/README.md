...
**Историческое общество:** кто чаще выживал на «Титанике» и что об этом говорят данные — отчёт для выставки, без «угадывания будущего». Подробнее — [UNIT.md §1](UNIT.md#1-идентификация).
