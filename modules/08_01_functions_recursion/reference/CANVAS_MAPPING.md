...
**Наш модуль:** `modules/08_01_functions_recursion/` — профиль ML, не общий IT.
...
| Рекурсия: max digit | max_digit_recursive | canvas_practice.md; КТП — модуль 7 |
| Рекурсия: binary_search | — | canvas_practice.md; КТП — модуль 7 |
