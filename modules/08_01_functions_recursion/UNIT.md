...
| Класс | 8 |
| Длительность (оценка) | 16 академических часов (8 пар КТП 1–8) |
| Сюжет модуля | Стажёры агентства недвижимости: честная оценка квартир и разбор отзывов клиентов |
...
Вы — **стажёры в агентстве недвижимости**. В базе сотни объявлений: площадь, цена, число комнат. Собственники спрашивают: «Сколько просить?» — нельзя отвечать наугад из таблицы в Excel. Руководство ждёт **понятный прототип оценщика**, которому можно показать клиенту. В конце стажировки отдел маркетинга приносит папку отзывов: **можно ли по тексту отличить довольных клиентов от недовольных?** — и просит рабочий ответ, а не «мы ещё учимся».
