...
Главное — практика уже известных приёмов без новой теории: ещё задачи на рекурсию, короткая запись функции через `lambda`, вызов нескольких готовых функций по очереди. Нужно закрепить то, что уже вводили, а не открывать следующую главу учебника.
