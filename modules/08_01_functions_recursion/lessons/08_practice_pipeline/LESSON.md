...
**Основная тема:** практика уже известных приёмов — рекурсия, короткая функция `lambda`, вызов нескольких функций по очереди. Новой теории нет.

**Побочно:** подготовка к итоговому файлу проекта (сами функции ещё собираем по частям).
