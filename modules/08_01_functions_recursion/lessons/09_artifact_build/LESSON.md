...
**Основная тема:** сборка функций модуля в один файл `text_stats.py` с проверкой автотестами (контракты + тесты).

**Побочно:** сравнение классов текстов, `naive_classify` и README — на паре 10.
