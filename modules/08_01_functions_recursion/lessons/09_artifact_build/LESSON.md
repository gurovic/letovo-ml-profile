...
**Основная тема:** собрать написанные за модуль функции в один файл и проверить их готовыми тестами.

**Побочно:** сравнение двух наборов текстов и классификация — на следующей паре.
