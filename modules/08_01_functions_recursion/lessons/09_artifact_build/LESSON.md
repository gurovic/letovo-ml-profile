...
Главное — собрать функции, написанные за модуль, в один файл проекта и убедиться, что они проходят готовые автоматические тесты. Это интеграция навыка, а не изучение новой конструкции языка.
