...
**Для учителя на уроке (не весь файл):** в wiki только три блока — **«A. Чего хотим от пары»** (1–2 абзаца: *зачем пара / чему учим*, без чеклиста артефактов), **B. Ход пары**, **C. Если сбились**. Без таблицы «Сценарий пары», без **D/E**, без **«Ориентир времени»** и без столбца **~мин** в ходе. Полный `LESSON.md` остаётся в репозитории. Ученические ноутбуки блок A **не** содержат.
