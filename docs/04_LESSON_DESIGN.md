...
1–2 коротких абзаца **только для учителя** (не в ученический ноутбук): проблема → что делает ученик → успех пары. На Canvas — заголовок **«A. Чего хотим от пары»** в начале wiki «План урока (для преподавателя)» ([08_CANVAS §11.4](08_CANVAS.md#114-план-пары-wiki-для-преподавателя)). Блок «Ориентир времени» в план не входит.
