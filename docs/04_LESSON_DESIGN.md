...
1–2 коротких абзаца **только для учителя** (не в ученический ноутбук): **зачем эта пара в модуле** и **чему учим** (способность / идея), без чеклиста мини-артефактов и «успеха сдачи». Минимум сдачи и ход — в таблице A и в B. На Canvas — заголовок **«A. Чего хотим от пары»** в начале wiki «План урока (для преподавателя)» ([08_CANVAS §11.4](08_CANVAS.md#114-план-пары-wiki-для-преподавателя)). Блок «Ориентир времени» и таблица «Сценарий пары» в план не входят.
