...
# 1 тема = 1 пара (2 академических часа). Итого: 86 пар.
...
MODULES = [
    {
        ...
        "note": "Пара 1 — вводная (ИИ, ML, профиль, организация обучения); пары 2–9 — введение и отработка; 10–11 — артефакт.",
        ...
        "themes": [
            ...
            "Практика: predict_*, MAE, batch_predict по APARTMENTS",
...
def render() -> str:
    ...
    if total != 86:
        raise ValueError(f"expected 86 pairs, got {total}")
